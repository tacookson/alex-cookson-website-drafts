...
Data inspection intro and code goes here
...
update_geom_defaults(GeomRichtext, list(hjust = 0, colour = "grey20",
...
gift_words_tfidf %>%
  ...
  geom_richtext(x = 0.248, y = 10.5, fill = "white",
                label = "Marshall Islands gifted many <span style = 'color:#BCA51F'>**elephant tusks**</span><br>in 2001, which purposefully <span style = 'color:#BCA51F'>**destroyed**</span>") +
  # Sweden
