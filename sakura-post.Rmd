...
Having day of year to over 10 decimal points of accuracy is overkill, though. Let's change the call we make to `frame_time` in the curly braces to round to the nearest integer.
...
p <- ggplot() +
  ...
  transition_events(start = flower_doy,
                    ...
                    enter_length = 5,
                    exit_length = 5) +
  ggtitle("{ymd(\"2019-01-01\") + frame_time}")
