...
p <- books_shrunk %>%
  ...
  scale_x_log10(labels = label_comma(accuracy = 1),
                breaks = 10 ^ c(0:5)) +
  labs(subtitle = "Dashed line show Bayesian prior for a book with 0 ratings",
       x = "Number of ratings",
       y = "Rating") +
...
```{r animation-ratings-1000, fig.align = 'center', fig.width = 8, fig.asp = 0.8}
