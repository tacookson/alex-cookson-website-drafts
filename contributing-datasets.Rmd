...
You're probably familiar with some of the classic "learning" datasets: mtcars, nycflights, and Titanic survivors, to name a few. Most of these are fine for simple illustrations in vignettes or toy examples, but they leave something to be desired. They're kind of boring.

Datasets are capable of so much more. They have the ability to prompt someone to exclaim, "Wow! That's so cool!" and come up with a huge list of questions they want to ask the data. In other words, datasets are able to provide tremendous motivation for learners to get answers to their questions, and learn R/data science/machine learning as a by-product of getting those answers.
