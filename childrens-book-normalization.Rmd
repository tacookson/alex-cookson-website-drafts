...
```{r animation-rescaling, fig.align = 'center', fig.width = 8, fig.asp = 0.7}
...
scaled_anim <- scaled %>%
  ...
  mutate(scale = ifelse(scale == "rating_eb_mean_centred", "Non-Rescaled Rating", "Rescaled Rating"))
...
```{r animation-normalizing, fig.align = 'center', fig.width = 8, fig.asp = 0.7}
# Get data in format to be animated
scaled_anim <- scaled %>%
