...
1. "Squeezing" or "stretching" the data to fit our target range
...
We can also visualize the "stretching" step of rescaling by looking at the *mean-centred* values of the original and rescaled data. (We use mean-centred values to get rid of the effects of the "shifting" step.)
...
Looking at the rescaled distribution: close, but not quite there.
