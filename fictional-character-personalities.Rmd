...
- PCA to get most of the information from the 250+ spectrums
- Clustering to determine which characters are similar to one another (regardless of the fictional work they're from)
- "Personality" of fictional works as a whole (challenge: using character personalities to infer the personality of a work as a whole)
- Add sex (male/female) and analyze how male/female characters are portrayed differently
